...
export default function GestionAlquilerPage() {
  return (
    <main className="min-h-screen bg-[#F0F4F8]">
      ...
      {/* Hero */}
      <section className="bg-[#F0F4F8] pt-36 pb-20 lg:pt-44 lg:pb-28 border-b border-[#C8D4E0]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <p className="text-[#C9A84C] tracking-[0.4em] uppercase text-xs font-medium mb-5">
            Servicio para propietarios
          </p>
          <h1 className="text-[#1A2240] text-4xl sm:text-5xl lg:text-6xl font-light leading-tight max-w-3xl mb-6">
            Gestión integral{" "}
            <span className="font-semibold">de tu alquiler</span>
          </h1>
          <p className="text-[#1A2240]/60 text-lg leading-relaxed max-w-2xl mb-10">
