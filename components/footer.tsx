        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-3">
              <a href={`tel:${config.telefonoHref}`} className="flex items-center gap-2.5 text-[#F5F0E8]/70 hover:text-[#C9A84C] text-sm transition-colors">
                <Phone size={14} className="text-[#C9A84C]" />
                {config.telefono}
              </a>
              <a href={`mailto:${config.email}`} className="flex items-center gap-2.5 text-[#F5F0E8]/70 hover:text-[#C9A84C] text-sm transition-colors">
