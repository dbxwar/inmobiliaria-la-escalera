...
export async function FeaturedProperties() {
  ...
  return (
    <section className="bg-[#F5F0E8] py-20 lg:py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
          <div>
            ...
            <h2 className="text-[#1B2B4B] text-3xl sm:text-4xl font-light leading-tight text-balance">
              Propiedades Destacadas
            </h2>
          </div>
          <Link
            href="/propiedades"
            className="text-sm text-[#1B2B4B] border-b border-[#C9A84C] pb-0.5 hover:text-[#C9A84C] transition-colors whitespace-nowrap self-start sm:self-auto"
          >
