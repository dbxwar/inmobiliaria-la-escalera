...
export function RentalContactModal() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    const text = `Hola, me interesa el servicio de gestión de alquiler para mi propiedad.
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center px-8 py-4 bg-[#C9A84C] text-[#1A2240] text-sm tracking-widest uppercase font-medium hover:bg-[#b8963e] transition-colors duration-200"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#F0F4F8] w-full max-w-md p-8 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[#1A2240] mb-1">
                  Mensaje <span className="text-[#1A2240]/40 font-normal">(opcional)</span>
                </label>
                <textarea
                  name="mensaje"
                  value={form.mensaje}
                  onChange={handleChange}
                  rows={3}
                  placeholder="Tipo de propiedad, superficie, situación actual..."
