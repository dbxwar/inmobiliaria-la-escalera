...
export function WhyChooseUs() {
  return (
    <section id="nosotros" className="bg-[#1B2B4B] py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-[#F5F0E8] text-3xl sm:text-4xl font-light leading-tight text-balance">
            ¿Por qué elegirnos?
          </h2>
        ...
        {/* Feature blocks */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#243656]">
          {features.map(({ icon: Icon, title, description }) => (
            <div
              key={title}
              className="bg-[#1B2B4B] hover:bg-[#243656] transition-colors duration-300 p-10 lg:p-12 flex flex-col items-start group"
            >
              {/* Icon circle */}
              ...
              <h3 className="text-[#F5F0E8] text-xl font-medium mb-4">{title}</h3>
              <p className="text-[#F5F0E8]/60 text-sm leading-relaxed">{description}</p>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={label}>
              ...
              <div className="text-[#F5F0E8]/50 text-xs tracking-widest uppercase">{label}</div>
            </div>
          ))}
        </div>
      </div>
