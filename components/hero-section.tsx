    ...
    <section className="relative h-screen min-h-[640px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 lg:px-10 text-center">
        ...
        <div className="bg-[#F5F0E8] shadow-2xl p-5 sm:p-6 max-w-4xl mx-auto">
          ...
          {/* Search Button */}
          <button className="w-full flex items-center justify-center gap-2 bg-[#C9A84C] hover:bg-[#b8943d] text-[#1B2B4B] font-semibold tracking-widest uppercase text-sm py-3.5 transition-colors duration-200">
            <Search size={16} />
            Buscar propiedades
          </button>
        </div>
